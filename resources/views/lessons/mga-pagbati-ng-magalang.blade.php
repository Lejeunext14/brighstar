<x-layouts::app :title="__('Mga Kulay - Interactive Lesson')">
        ...
        <div class="w-full lg:w-1/3 flex justify-center">
            <div class="teacher-wrap flex items-end justify-start">
                ...
                <div class="teacher-bubble text-sm sm:text-base">
                    Kumusta! Matuto tayo ng mga pagbati ng magalang.
                </div>
        ...
        <div class="w-full lg:w-2/3">
            ...
            <div id="blackboard" class="bg-gradient-to-b from-green-700 to-green-800 rounded-lg shadow-2xl p-4 sm:p-6 lg:p-8 border-4 sm:border-8 border-amber-900 min-h-96">
                <div class="text-white">
                    <h2 id="blackboardTitle" class="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 lg:mb-6 text-center drop-shadow-lg">Mga Pagbati ng Magalang</h2>
    ...
    <script>
        ...
        const blackboardSlides = [
            {
                title: 'Mga Pagbati ng Magalang',
                body: '<p>Maligayang pagdating! Sa araling ito, matututunan natin ang mga pagbati ng magalang.</p>'
            },
            {
                title: 'Magandang Umaga, Po!',
                body: '<p>Magandang Umaga, Po! — Ito ang pagbati sa umaga na may paggalang.</p><p class="mt-2">Ginagamit ito mula 5:00 AM hanggang 12:00 noon.</p><p class="mt-4"><img src="/image/magandang_umaga.jpg" alt="Magandang Umaga" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Magandang Hapon, Po!',
                body: '<p>Magandang Hapon, Po! — Ito ang pagbati sa hapon na may paggalang.</p><p class="mt-2">Ginagamit ito mula 12:00 noon hanggang 5:00 PM.</p><p class="mt-4"><img src="/image/magandang_hapon.jpg" alt="Magandang Hapon" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Magandang Gabi, Po!',
                body: '<p>Magandang Gabi, Po! — Ito ang pagbati sa gabi na may paggalang.</p><p class="mt-2">Ginagamit ito mula 5:00 PM hanggang 12:00 hating gabi.</p><p class="mt-4"><img src="/image/magandang_gabi.jpg" alt="Magandang Gabi" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Kumusta, Po?',
                body: '<p>Kumusta, Po? — Ito ay paraan ng pagpapakita ng interes sa kalusugan ng iba.</p><p class="mt-2">Ginagamit ito upang magsimula ng pakikipag-usap.</p><p class="mt-4"><img src="/image/kumusta.jpg" alt="Kumusta" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Maraming Salamat, Po!',
                body: '<p>Maraming Salamat, Po! — Ito ang pagpapasalamat na may paggalang.</p><p class="mt-2">Ginagamit ito upang magpasalamat sa tulong o kabutihan.</p><p class="mt-4"><img src="/image/salamat.jpg" alt="Salamat" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Paumanhin, Po!',
                body: '<p>Paumanhin, Po! — Ito ay paraan ng pagpapakita ng pag-amin ng kamalian.</p><p class="mt-2">Ginagamit ito upang humingi ng patawad sa magulang at matatanda.</p><p class="mt-4"><img src="/image/paumanhin.jpg" alt="Paumanhin" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            }
        ];
        ...
        function finishLesson() {
            ...
            fetch('{{ route("lesson.mark-complete") }}', {
                ...
                body: JSON.stringify({ lesson_slug: 'mga-pagbati-ng-magalang' })
            })
            .then(res => {
