<x-layouts::app :title="__('Mga Kulay - Interactive Lesson')">
        ...
        <div class="w-full lg:w-3/4">
            ...
            <div id="blackboard" class="bg-gradient-to-b from-green-700 to-green-800 rounded-lg shadow-2xl p-4 sm:p-6 lg:p-8 border-4 sm:border-8 border-amber-900 min-h-96">
                <div class="text-white">
                    <h2 id="blackboardTitle" class="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 lg:mb-6 text-center drop-shadow-lg">Ang Titik E</h2>
    ...
    <script>
        ...
        const blackboardSlides = [
            {
                title: 'Ang Titik E',
                body: '<p>Maligayang pagdating! Sa araling ito, matututunan natin ang titik E.</p>'
            },
            {
                title: 'Malaking E (Capital E)',
                body: '<p>Ito ang malaking anyo ng titik E. Ginagamit natin ito sa simula ng pangungusap.</p><p class="mt-2">Halimbawa: Espesyal, Estudyante, Enganche</p><p class="mt-4"><img src="/image/capital_e.jpg" alt="Capital E" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Maliit na e (Lowercase e)',
                body: '<p>Ito ang maliit na anyo ng titik E. Ginagamit natin ito sa karamihan ng salita.</p><p class="mt-2">Halimbawa: espesyal, estudyante, enganche</p><p class="mt-4"><img src="/image/lowercase_e.jpg" alt="Lowercase e" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Tunog ng E',
                body: '<p>Ang titik E ay may tunog na &quot;eh&quot; tulad ng sa salitang &quot;elepante&quot;.</p><p class="mt-2">Magsanay: &quot;E&quot; - eh, eh, eh</p><p class="mt-4"><img src="/image/sound_e.jpg" alt="Sound E" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Salita na May E',
                body: '<p>Maraming salita ang nagsisimula sa titik E.</p><p class="mt-2">Elepante, Edukasyon, Emosyon, Espesyo, Ekskwela</p><p class="mt-4"><img src="/image/words_with_e.jpg" alt="Words with E" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Pagisipan ang E',
                body: '<p>Finifingerprint natin ang titik E upang maunawaan ang sulat nito.</p><p class="mt-2">Mayroon itong tatlong pahalang na linya at isang patayo na linya sa gitna.</p><p class="mt-4"><img src="/image/trace_e.jpg" alt="Trace E" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Pagsasanay ng E',
                body: '<p>Dapat tayong magsanay na sulatin at sabihin ang titik E nang maraming beses.</p><p class="mt-2">Ito ay makakatulong sa atin na matandaan ang titik E.</p><p class="mt-4"><img src="/image/practice_e.jpg" alt="Practice E" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            }
        ];
        ...
        function finishLesson() {
            ...
            fetch('{{ route("lesson.mark-complete") }}', {
                ...
                body: JSON.stringify({ lesson_slug: 'ang-titik-ee' })
            })
            .then(res => {
