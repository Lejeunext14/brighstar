        ...
        <div class="w-full lg:w-1/3 flex justify-center">
            <div class="teacher-wrap flex items-end justify-center">
                ...
                <div class="teacher-bubble text-sm sm:text-base">
                    Kumusta! Matuto tayo ng Alpabetong Filipino.
                </div>
            </div>
        </div>
        ...
        <div class="w-full lg:w-2/3">
            ...
            <div id="blackboard" class="bg-gradient-to-b from-green-700 to-green-800 rounded-lg shadow-2xl p-4 sm:p-6 lg:p-8 border-4 sm:border-8 border-amber-900 min-h-96">
                <div class="text-white">
                    <h2 id="blackboardTitle" class="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 lg:mb-6 text-center drop-shadow-lg">Ang Alpabetong Filipino</h2>
    ...
    <script>
        ...
        const blackboardSlides = [
            {
                ...
                body: '<p>Maligayang pagdating! Sa araling ito, matututunan natin ang Alpabetong Filipino.</p>'
            },
            {
                title: 'Ang Alpabeto - Unang Bahagi',
                body: '<p>A - B - C - D - E - F - G - H - I - J</p><p class="mt-2">Ang mga unang sampung titik ng alpabeto.</p><p class="mt-4"><img src="/image/alpabeto1.jpg" alt="Alpabeto 1" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Ang Alpabeto - Pangalawang Bahagi',
                body: '<p>K - L - M - N - Ñ - O - P - Q - R</p><p class="mt-2">Ang susunod na siyam na titik kasama ang Ñ.</p><p class="mt-4"><img src="/image/alpabeto2.jpg" alt="Alpabeto 2" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Ang Alpabeto - Pangatlong Bahagi',
                body: '<p>S - T - U - V - W - X - Y - Z - Ng</p><p class="mt-2">Ang huli na siyam na titik kasama ang Ng.</p><p class="mt-4"><img src="/image/alpabeto3.jpg" alt="Alpabeto 3" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Kabuuang Bilang ng Titik',
                body: '<p>Ang Alpabetong Filipino ay may 28 titik sa kabuuan.</p><p class="mt-2">Kasama dito ang mga pandaigdigang titik at ang mga natatanging Filipino na titik tulad ng Ñ at Ng.</p><p class="mt-4"><img src="/image/alpabeto_count.jpg" alt="Alpabeto Count" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Kahalagahan ng Alpabeto',
                body: '<p>Ang pag-alam ng alpabeto ay mahalaga upang matuto ng pagbabasa at pagsusulat.</p><p class="mt-2">Ito ang pundasyon ng lahat ng pagkatuto.</p><p class="mt-4"><img src="/image/alpabeto_importance.jpg" alt="Alpabeto Importance" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Pagsasanay ng Alpabeto',
                body: '<p>Dapat tayong magsanay na isaayos ang mga titik sa tamang pagkakasunod-sunod.</p><p class="mt-2">Ito ay tutulong sa atin na maging maayos sa pagbabasa at pagsusulat.</p><p class="mt-4"><img src="/image/alpabeto_practice.jpg" alt="Alpabeto Practice" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            }
        ];
        ...
        function finishLesson() {
            ...
            fetch('{{ route("lesson.mark-complete") }}', {
                ...
                body: JSON.stringify({ lesson_slug: 'ang-alpabetong-filipino' })
            })
            .then(res => {
