<x-layouts::app :title="__('Mga Kulay - Interactive Lesson')">
        ...
        <div class="w-full lg:w-2/3">
            ...
            <div id="blackboard" class="bg-gradient-to-b from-green-700 to-green-800 rounded-lg shadow-2xl p-4 sm:p-6 lg:p-8 border-4 sm:border-8 border-amber-900 min-h-96">
                <div class="text-white">
                    <h2 id="blackboardTitle" class="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 lg:mb-6 text-center drop-shadow-lg">Mga Kasapi ng Pamilya</h2>
    ...
    <script>
        ...
        const blackboardSlides = [
            {
                title: 'Mga Kasapi ng Pamilya',
                body: '<p>Maligayang pagdating! Sa araling ito, matututunan natin ang mga kasapi ng pamilya.</p>'
            },
            {
                title: 'Ama',
        ...
        function finishLesson() {
            ...
            fetch('{{ route("lesson.mark-complete") }}', {
                ...
                body: JSON.stringify({ lesson_slug: 'mga-kasapi-ng-aking-pamilya' })
            })
            .then(res => {
