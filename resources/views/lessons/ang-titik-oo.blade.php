<x-layouts::app :title="__('Mga Kulay - Interactive Lesson')">
        ...
        <div class="w-full lg:w-1/3 flex justify-center">
            <div class="teacher-wrap flex items-end justify-center">
                ...
                <div class="teacher-bubble text-sm sm:text-base">
                    Kumusta! Matuto tayo ng Titik O.
                </div>
            </div>
        </div>
        ...
        <div class="w-full lg:w-2/3">
            ...
            <div id="blackboard" class="bg-gradient-to-b from-green-700 to-green-800 rounded-lg shadow-2xl p-4 sm:p-6 lg:p-8 border-4 sm:border-8 border-amber-900 min-h-96">
                <div class="text-white">
                    <h2 id="blackboardTitle" class="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 lg:mb-6 text-center drop-shadow-lg">Ang Titik O</h2>
    ...
    <script>
        ...
        const blackboardSlides = [
            {
                title: 'Ang Titik O',
                body: '<p>Maligayang pagdating! Sa araling ito, matututunan natin ang titik O.</p>'
            },
            {
                title: 'Malaking O (Capital O)',
                body: '<p>Ito ang malaking anyo ng titik O. Ginagamit sa simula ng pangungusap.</p><p class="mt-2">Halimbawa: Oso, Orasan, Opisina</p><p class="mt-4"><img src="/image/capital_o.jpg" alt="Capital O" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Maliit na o (Lowercase o)',
                body: '<p>Ito ang maliit na anyo ng titik o. Karaniwan sa loob ng mga salita.</p><p class="mt-2">Halimbawa: oso, orasan, opisina</p><p class="mt-4"><img src="/image/lowercase_o.jpg" alt="Lowercase o" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Tunog ng O',
                body: '<p>Ang titik O ay may tunog na &quot;oh&quot; tulad ng sa salitang &quot;oso&quot;.</p><p class="mt-2">Magsanay: &quot;O&quot; - oh, oh, oh</p><p class="mt-4"><img src="/image/sound_o.jpg" alt="Sound O" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Salita na May O',
                body: '<p>Ilan sa mga salita: Oso, Orasan, Opisina, Ospital, Oplan</p><p class="mt-4"><img src="/image/words_with_o.jpg" alt="Words with O" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Pag-trace ng O',
                body: '<p>Aralin kung paano isulat ang malaking O at maliit na o.</p><p class="mt-2">Magsanay ng bilog na hugis para sa titik O.</p><p class="mt-4"><img src="/image/trace_o.jpg" alt="Trace O" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Pagsasanay ng O',
                body: '<p>Magsanay magsulat at magbigkas ng mga salita na may titik O.</p><p class="mt-2">Gumawa ng 5 salita na may O at basahin nang malakas.</p><p class="mt-4"><img src="/image/practice_o.jpg" alt="Practice O" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            }
        ];
        ...
        function finishLesson() {
            ...
            fetch('{{ route("lesson.mark-complete") }}', {
                ...
                body: JSON.stringify({ lesson_slug: 'ang-titik-oo' })
            })
            .then(res => {
