        ...
        <div class="w-full lg:w-2/3">
            ...
            <div id="blackboard" class="bg-gradient-to-b from-green-700 to-green-800 rounded-lg shadow-2xl p-4 sm:p-6 lg:p-8 border-4 sm:border-8 border-amber-900 min-h-96">
                <div class="text-white">
                    <h2 id="blackboardTitle" class="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 lg:mb-6 text-center drop-shadow-lg">Ang Aking Pamilya</h2>
    ...
    <script>
        ...
        const blackboardSlides = [
            {
                ...
                body: '<p>Maligayang pagdating! Sa araling ito, matututunan natin ang tungkol sa ating pamilya.</p>'
            },
            {
                title: 'Ang Pamilya',
            ...
            },
            {
                ...
                body: '<p>Magkasama ang pamilya sa mga espesyal na sandali at pagdiriwang.</p><p class="mt-4"><img src="/image/kasama.jpg" alt="Kasama" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Pagsasalita ng Magalang',
                body: '<p>Dapat tayong magsalita ng magalang at may paggalang sa ating mga magulang.</p><p class="mt-4"><img src="/image/magalang.jpg" alt="Magalang" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            },
            {
                title: 'Malusog na Pamilya',
                body: '<p>Ang malusog na pamilya ay mahalaga. Dapat tayong mag-ingat ng ating kalusugan.</p><p class="mt-4"><img src="/image/malusog.jpg" alt="Malusog" style="width:200px; height:auto; margin:0 auto; display:block; border-radius:8px;"/></p>'
            }
        ];
        ...
        function finishLesson() {
            ...
            fetch('{{ route("lesson.mark-complete") }}', {
                ...
                body: JSON.stringify({ lesson_slug: 'ang-aking-pamilya' })
            })
            .then(res => {
